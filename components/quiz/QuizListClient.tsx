...
export default function QuizListClient({ quizzes }: { quizzes: Quiz[] }) {
        ...
        <SidebarInset className="flex-1 overflow-auto" style={{ backgroundColor: "var(--background-secondary)" }}>
          ...
          <div className="p-4 lg:p-6">
            ...
            <div className="hidden lg:flex mb-6 items-start justify-between gap-6">
              <div>
                ...
                <h1 className="mt-2 text-4xl font-semibold leading-tight" style={{ fontFamily: "var(--font-serif)", color: "var(--foreground)" }}>
                  Find your next <span style={{ color: "var(--gold)", fontStyle: "italic" }}>read</span>
                </h1>
                <p className="mt-3 text-sm" style={{ color: "var(--foreground-muted)" }}>
                  Answer a few questions. Let AI match you with the right book.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-3">
              {quizzes.map((quiz) => (
                <Link key={quiz.slug} href={`/quiz/${quiz.slug}`} style={{ textDecoration: "none" }}>
                  <div
                  ...
                  >
                    ...
                    {/* Arrow */}
                    <span className="text-lg flex-shrink-0 pt-1" style={{ color: "var(--foreground-muted)" }}>→</span>
                  </div>
                </Link>
              ))}
            </div>
